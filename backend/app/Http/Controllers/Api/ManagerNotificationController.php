...
use App\Http\Requests\ManagerNotificationRequest;
...
{
    public function index(ManagerNotificationRequest $request, CustomerNotificationService $notifications): JsonResponse
    {
