...
use App\Http\Requests\StaffNotificationRequest;
...
{
    public function index(StaffNotificationRequest $request, CustomerNotificationService $notifications): JsonResponse
    {
